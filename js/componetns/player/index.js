            ...
            <View style={this._rotatable(rotate)}>
                ...
                <View style={styles.buttons}>
                    <View style={styles.buttonsBody}>
                        <TouchableHighlight activeOpacity={0.7} underlayColor={'rgba(24, 110, 168, 0.3)'} style={styles.left} onPress={() => this.onChangeScore(id, -1)}>
                            <Text style={styles.leftText}>-</Text>
                        </TouchableHighlight>
                        <TouchableHighlight activeOpacity={0.7} underlayColor={'rgba(24, 110, 168, 0.3)'} style={styles.right} onPress={() => this.onChangeScore(id, +1)}>
